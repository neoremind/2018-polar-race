...
public final class SizeOf {
  ...
  public static final byte SIZE_OF_KEY = 8;

  public static final short SIZE_OF_VALUE = 4096;

  public static final short SIZE_OF_KEY_AND_VALUE = 4104;

  public static final short SIZE_OF_WAL_RECORD = SIZE_OF_KEY + SIZE_OF_INT;

  public static final short SIZE_OF_VLOG_RECORD = SIZE_OF_VALUE;
