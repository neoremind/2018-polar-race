 ...
 * @author xu.zx
 */
public class ConcurrentMmapLoad2MappedByteBufferVLogCache extends AbstractVLogCache implements VLogCache {
  ...
  public ConcurrentMmapLoad2MappedByteBufferVLogCache(File file, ExecutorService prepareLoadExecutor,
  ...
  public byte[] read(int offset) {
    ...
    ByteBuffer b = mappedByteBuffers[offset / SEGMENT_SIZE];
