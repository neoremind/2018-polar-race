...
public class NativeMappedConverter implements TypeConverter {
    ...
    public static NativeMappedConverter NATIVE_LONG_CONVERTER;
    public static NativeMappedConverter POINTER_BY_REF_CONVERTER;

    static {
        NATIVE_LONG_CONVERTER =  _getInstance(NativeLong.class);
        POINTER_BY_REF_CONVERTER = _getInstance(PointerByReference.class);
    }

    public static NativeMappedConverter _getInstance(Class<?> cls) {
